...
Email | String | E-mail для отправки терминального чека | не обязательный
Phone | String | Номер телефона для отправки терминального чека | не обязательный
...
### 8. ru.toucan.RETURN_CASH_PAYMENT

...
public class Open extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.createFields(Open.this, layout, titleView, Settings.getParameters(), false);
    }

    public void pay(View v) {

        Intent intent = new Intent();
        intent.setAction(APIActions.OPEN);
        ...
        startActivityForResult(intent, RequestCode.OPEN.ordinal());
    }
